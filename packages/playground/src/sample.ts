...
//
// This URL is byte-equal to `crates/cli/tests/cli.rs` `TINY_IREAL_URL`
// (see #2358). The two sites are sister fixtures: a future change to
// the upstream corpus URL must update both. Kept duplicated rather than
// shared via a generated module so the cli test crate keeps its
// zero-dep status.
