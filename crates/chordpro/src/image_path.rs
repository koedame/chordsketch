...
//! Centralising them in `chordsketch-chordpro` avoids duplication and ensures
...
///
/// ```
/// use chordsketch_chordpro::image_path::is_windows_absolute;
///
...
///
/// ```
/// use chordsketch_chordpro::image_path::has_traversal;
///
...
/// rejected.
///
/// Centralising this check in `chordsketch-chordpro` keeps the three
