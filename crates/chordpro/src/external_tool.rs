...
///
/// ```no_run
/// use chordsketch_chordpro::external_tool::is_available;
///
...
/// `chordsketch-chordpro` has zero external dependencies, this is implemented
...
mod tests {
    ...
    // Run with: cargo test -p chordsketch-chordpro -- --ignored
