...
section > .section-label, .chorus-recall > .section-label { font-family: \"Inter\", system-ui, -apple-system, sans-serif; font-weight: 600; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.12em; color: #67646D; border-top: 1px solid #E8E6EA; padding-top: 0.5em; margin-bottom: 0.5em; }
section:first-of-type > .section-label, .chorus-recall:first-of-type > .section-label { border-top: 0; padding-top: 0; }
