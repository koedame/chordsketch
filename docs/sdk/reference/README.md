...
| [`<Playground>`](#/reference/playground) | One-component editor + preview + transpose composite |
| [Editors](#/reference/editors) | `<ChordEditor>` (textarea baseline), `<SourceEditor>` (CodeMirror), `chordProLanguage`, `chordProTagTable` |
...
| Topic | Covers |
|---|---|
| [Components](#/reference/ireal-components) | `<IrealEditor>`, `<IrealPreview>`, `<IrealPlayground>` |
