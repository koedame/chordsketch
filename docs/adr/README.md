...
| [0033](0033-canonical-key-directive-notation.md) | Canonical `{key}` notation + a single strict key parser (`parse_key`); malformed keys (`G m`, `Gminor`, `G minor`, `G7`) warn and render verbatim instead of being silently mis-classified | Accepted (2026-06-17) |
