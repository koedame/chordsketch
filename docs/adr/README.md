...
| [0039](0039-center-inline-chord-diagrams-over-lyric.md) | Inline chord diagrams (`{diagrams: inline}`) are centered over their lyric segment, not left-edge-aligned; refines ADR-0027's compact-diagram placement. Chord-name and hover modes stay left-aligned; one mode-scoped CSS rule in the React walker, no overflow, no AST change | Accepted (2026-06-27) |
