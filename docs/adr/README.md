...
| [0026](0026-horizontal-chord-diagram-default-string-order.md) | Horizontal chord diagrams default to reader-view (high pitch on top, matches tablature stave order) | Accepted (2026-05-29) |
